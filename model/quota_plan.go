...
const (
	...
	QuotaAdjustmentActionTemporaryGrant QuotaAdjustmentAction = "temporary_grant"
	QuotaAdjustmentActionSettlement     QuotaAdjustmentAction = "settlement"
)
...
type QuotaPlan struct {
	...
	Purpose               string          `json:"purpose" gorm:"type:varchar(500)"`
	...
	AllocationBeforeQuota *int64          `json:"-" gorm:"bigint"`
	AllocationAfterQuota  *int64          `json:"-" gorm:"bigint"`
...
// TableName returns the stable quota-plan table.
...
// TableName returns the stable quota-item table.
