...
func applyConvertedSystemPromptIfNeeded(c *gin.Context, info *relaycommon.RelayInfo, request any) {
	...
	case *vertex.VertexAIClaudeRequest:
		if request != nil {
			claudeRequest := &dto.ClaudeRequest{System: request.System}
			applyClaudeSystemPromptIfNeeded(c, info, claudeRequest)
			request.System = claudeRequest.System
		}
