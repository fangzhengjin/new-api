...
func setupQuotaTestDB(t *testing.T) *gorm.DB {
	...
	require.NoError(t, db.AutoMigrate(
		&model.Option{}, &model.User{}, &model.Log{}, &model.AuditLog{}, &model.QuotaCycle{}, &model.QuotaPlan{}, &model.QuotaItem{},
	...
	require.NoError(t, db.Create(&model.User{Username: "root", AffCode: "test-root", Role: common.RoleRootUser, QuotaWhitelist: true}).Error)
