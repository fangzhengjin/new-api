...
const labels = {
  ...
  grant: 'Grant',
  reclaim: 'Reclaim',
  temporary_grant: 'Temporary quota',
  pending: 'Pending',
  sent: 'Sent',
  failed: 'Failed',
  skipped: 'Skipped',
...
export function PlanTypeBadge(props: { type: PlanType; t: TFunction }) {
  return <Badge variant='outline'>{props.t(labels[props.type])}</Badge>
}
