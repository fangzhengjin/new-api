...
export function UsersTable() {
  ...
  const columns = useUsersColumns(companyQuotaModeEnabled)
  ...
  if (companyQuotaModeEnabled && quotaWhitelistFilter[0] === 'true') {
    quotaWhitelist = true
  } else if (companyQuotaModeEnabled && quotaWhitelistFilter[0] === 'false') {
